...
{'_type': 'HELPER', 'resourceId': 'Selection[]', 'lastSelectedId': 'd85a672a-41a2-49c5-8e7f-201cd8dbfbec', 'selectedIds': ['ccefc122-e8e6-4982-b2e6-6dd4e5da70ef', '55a35a1a-a5b3-42bd-9df7-b6cd6bae020f', 'd85a672a-41a2-49c5-8e7f-201cd8dbfbec']}

class Selection(SlobsBase, SelectionBase):
    def __init__(self, connection, resource_id):
        SlobsBase.__init__(self,
